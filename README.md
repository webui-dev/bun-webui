...
[![][last-commit]](https://github.com/webui-dev/bun-webui/pulse)
[![][release-version]](https://github.com/webui-dev/bun-webui/releases/latest)
[![][license]](https://github.com/webui-dev/bun-webui/blob/main/LICENSE)
...
This [hello world example](https://github.com/webui-dev/bun-webui/tree/main/examples/hello_world)
is written in Bun using WebUI as the GUI library.
...
[More examples](https://github.com/webui-dev/bun-webui/tree/main/examples)
...
| TS / JS (Deno)  | ✔️ |  _not complete_ | [Deno-WebUI](https://github.com/webui-dev/bun-webui)      |
...
[![Stargazers repo roster for @webui-dev/bun-webui](https://reporoster.com/stars/webui-dev/bun-webui)](https://github.com/webui-dev/bun-webui/stargazers)
