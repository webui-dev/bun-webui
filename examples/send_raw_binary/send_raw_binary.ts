...
<html>
  <head>
    <script src="webui.js"></script>
      <title>WebUI 2 - Bun Send Raw Binary Example</title>
    <style>
      body {
    ...
    <body>
        <h1>WebUI 2 - Bun Send Raw Binary Example</h1>
        <br>
...
async function get_raw_picture(e: WebUI.Event) {
  const pictureRaw = new Uint8Array(await Bun.file("./webui.jpeg").arrayBuffer());
